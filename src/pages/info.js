...
const InfoPage = () => {
    return (
        <Layout>
            <Container maxW='7xl'>
            <Heading mb='10' fontSize="7xl" align="center" marginTop="10">Money for the future.</Heading>
            <Text fontSize="lg" align="start">Kryptokrona exists to secure and simplify our future economic system. Sending and receiving money should not be expensive or slow. We work with open source code that allows you to be involved and improve the money of the future.
